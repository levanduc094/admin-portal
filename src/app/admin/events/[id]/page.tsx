          ...
          <div className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 2xl:col-span-2">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                name="countries"
                className="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border-gray-300 bg-gray-50 p-2.5 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
              >
            ...
            <div>
              <button className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white focus:ring-4">
                Save all
              </button>
            </div>
          </div>
                ...
                <li className="py-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="inline-flex items-center">
                      <a
                        href="#"
                        className="focus:ring-primary-300 mb-3 mr-3 rounded-lg border border-gray-300 bg-white px-3 py-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                      >
                        Disconnect
                      </a>
                    </div>
                ...
                <li className="py-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="inline-flex items-center">
                      <a
                        href="#"
                        className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mb-3 mr-3 rounded-lg px-3 py-2 text-center text-sm font-medium text-white focus:ring-4"
                      >
                        Connect
                      </a>
                    </div>
          ...
          <div className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 2xl:col-span-2">
            <div className="flow-root">
              ...
              <ul className="mb-6 divide-y divide-gray-200 dark:divide-gray-700">
                <li className="py-4">
                  <div className="align-center flex justify-between xl:block 2xl:flex 2xl:space-x-4">
                    ...
                    <div className="inline-flex w-auto items-center xl:w-full 2xl:w-auto">
                      <a
                        href="#"
                        className="focus:ring-primary-300 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                      >
                        Disconnect
                      </a>
                    </div>
              ...
              <div className="flex items-center justify-between py-4">
                ...
                >
                  <input
                    ...
                    className="sr-only"
                  />
                  <span className="toggle-bg h-6 w-11 rounded-full border border-gray-200 bg-gray-200 dark:border-gray-600 dark:bg-gray-700"></span>
                </label>
              </div>
              <div className="flex items-center justify-between py-4">
                <div className="flex flex-grow flex-col">
